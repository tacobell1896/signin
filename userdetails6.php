...
while($row = mysqli_fetch_assoc($result))
  {
	...
	echo '<form method="post" action="udetails.php">';
	 echo '<div class="row edit-row">';
		echo '<div class="col name-edit" id="">' . $row['t_name'] . '</div><div class="clear"></div>';
		echo '<div class="col phone" id="">' . $row['t_phone'] . '</div><div class="clear"></div>';
		echo '<div class="col email" id=""><a href="mailto:' . $row['t_email'] . '">' . $row['t_email'] . '</a></div><div class="clear"></div>';
